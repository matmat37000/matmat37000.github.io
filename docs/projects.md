...
Here you can find a list of all my projects. Private / unreleased projects will be preceded by an {{ repo_private_icon }}.
...
| Drone Sim {{ repo_private_icon }}                     | 2025 | On going          | A drone simulator in Godot for another personal project. The code is a bit dirty and it lack of some features. It will become public when at presentable state. (C#/C++)    |
...
{{ github_top_language('matmat37000',  'microbits-cars') }}
{{ github_repo_licence('matmat37000',  'microbits-cars') }}
